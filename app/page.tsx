        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="mb-8">
            <h1 className="text-8xl md:text-9xl font-black mb-4 tracking-tight">
              <span className="text-pink-500 drop-shadow-2xl">H</span>
              <span className="text-pink-500 drop-shadow-2xl">o</span>
              <span className="text-pink-500 drop-shadow-2xl">T</span>
            </h1>
            <div className="text-2xl md:text-4xl font-bold text-orange-500 mb-2">HOUSE</div>
            <div className="text-lg md:text-xl text-orange-400 mb-2">of</div>
            <div className="text-2xl md:text-4xl font-bold text-orange-500">TECHNO</div>
          </div>
      ...
      <section className="py-20 bg-gray-800/50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">
            <span className="text-cyan-400">Experience</span> <span className="text-pink-500">HoT</span>
          </h2>
      ...
      <section className="py-20 bg-gradient-to-r from-pink-500/20 via-purple-500/20 to-orange-500/20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Ready to feel the <span className="text-pink-500">HoT</span> beats?
          </h2>
